...
from inference.core.logging import logger
from inference.ai.autohf import AutoHF
from inference.ai.softprompt import SoftPrompt, AutoModelForSoftPromptLM, current_sp, resize_model_embeddings
from inference.ai.tensorize import tensorize, untensorize
from inference.ai.utils import Checkpoint, get_dtype, tensorized_path
from inference.ai.warpers import *
...
try:
    import transformers
    from inference.ai.quantization import GPTJBlock, GPTJForCausalLM
except ImportError:
...
class GPTHF(AutoHF):
    ...
    def generate(self, args):
        ...
        if 'softprompt' in args and args['softprompt'] is not None:
